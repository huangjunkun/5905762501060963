package com.common 
{
	...
	{	
        ...
        private function init() : void {
            ...
            leftBottom = getBitmap(0, scaleGridBottom, scaleGridLeft, _height - scaleGridBottom);
            ...
            centerBottom = getBitmap(scaleGridLeft, scaleGridBottom, scaleGridRight - scaleGridLeft, _height - scaleGridBottom);
            this.addChild(centerBottom);
            
            rightUp = getBitmap(scaleGridRight, 0, _width - scaleGridRight, scaleGridTop);
            this.addChild(rightUp);
            
            rightCenter = getBitmap(scaleGridRight, scaleGridTop, _width - scaleGridRight, scaleGridBottom - scaleGridTop);
            this.addChild(rightCenter);
            
            rightBottom = getBitmap(scaleGridRight, scaleGridBottom, _width - scaleGridRight, _height - scaleGridBottom);
