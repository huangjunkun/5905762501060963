package zuffy.display
{
	...
	public class CtrBar extends Sprite{
		...
		public function CtrBar(w = 352, h = 293 , has_fullscreen = 0, playctrlhandler = null) {
		...
		private function addCtr(){
			...
			addChild(_btnPlayBig);
			addChild(_btnPauseBig);
...
/*			_barBg.y=-6;
			...
			if (stage)
			{
				this.parent.addChild(_btnPlayBig);
				this.parent.addChild(_btnPauseBig);
			}
		}
